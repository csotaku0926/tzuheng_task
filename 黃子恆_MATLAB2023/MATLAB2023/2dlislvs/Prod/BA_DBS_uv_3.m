% 雙向 A* 輔助函數
function [path, total_distance, elapsed_time, visited_nodes_dijk, search_count_dijk] = BA_DBS_uv_3(satellite_coords, start_satellite, end_satellite, total_satellites_sum)
