% A*輔助函數
function [path, total_distance, elapsed_time, visited_nodes, search_count] = A_star_algorithm(satellite_coords, start_satellite, end_satellite, total_satellites_sum)
