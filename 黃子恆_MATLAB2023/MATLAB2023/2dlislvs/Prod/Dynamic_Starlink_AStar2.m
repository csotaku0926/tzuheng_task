...
for minute = 0:1:1
    ...
    % 使用雙向A*演算法找到最短衛星路徑
    [satellite_path_BA_star, total_satellite_distance_BA_star, BA_star_time, BA_visited_nodes, search_count_ba_star] = A_star_bidirectional_algorithm2_3(satellite_coords, start_satellite, end_satellite, total_satellites_sum);
