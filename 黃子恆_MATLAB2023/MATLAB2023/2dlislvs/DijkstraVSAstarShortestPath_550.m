...
orbit_altitude = 540; % 550
total_satellites = 4400; % 2000
num_orbits = 100; % 50
atm_high = 80;
...
% 定義地面站座標
New_York_coords = [40.730610, -73.935242];
% New_York_coords = [40.7128, -74.0060];
Sydney_coords = [-26.195246, 28.034088];
...
%function neighbors = find_neighbors(satellite_coords, current_satellite, max_dis_perhop)
    neighbors = [];
