function [rc_path, w, elapsed_time, n_visited, iter_count, update_cost_count] = A_star_RC(L_batt, P, satellite_coords, ...
    ...
    while i <= length(P)
        ...
        [new_path, ~, ~, fs_visited, a_iter_cnt, a_update_cnt] = A_star_algorithm(satellite_coords, p_prev, p_next, sum(n_sat_list), ...
        ...
        iter_count = iter_count + a_iter_cnt;
        update_cost_count = update_cost_count + a_update_cnt;
        i = next_idx + 1;
    end
