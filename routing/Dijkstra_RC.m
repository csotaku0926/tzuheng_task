function [rc_path, w, elapsed_time, n_visited, iter_count, update_cost_count] = Dijkstra_RC(L_batt, P, satellite_coords, ...
    ...
    while i <= length(P)
        ...
        [new_path, ~, ~, fs_visited, iter_cnt, dij_update_cnt] = Dijkstra_algorithm(satellite_coords, p_prev, p_next, sum(n_sat_list), ...
        ...
        iter_count = iter_count + iter_cnt;
        update_cost_count = update_cost_count + dij_update_cnt;
        i = next_idx + 1;
    end
